module.exports = {
	...
	{client
		...
		// the username value is a placeholder. Please use your name for testing.
		.setValue('input[name="username"]', 'value') 
        // the password value is a placeholder. Please use your password for testing.		
